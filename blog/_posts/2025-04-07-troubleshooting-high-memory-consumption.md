...
![working_set_graph](../assets/images/tshoot-memory-consuption/working_set.png)
...
![go_heap](../assets/images/tshoot-memory-consuption/comparing_ws_heap.png.png)
...
![Kubernetes metrics architecture image](../assets/images/tshoot-memory-consuption/metrics_pipeline.png)
...
The `pod` we used as an example consumes approximately `383 MB`, a value much higher than expected for an application with a low level of memory allocation.

From the `memory.stat` file, I calculated the percentage distribution of the largest statistics in relation to `working_set`, and the result was:
...
![working_set_after_drop_cache](../assets/images/tshoot-memory-consuption/working_set_after_drop.png)
