...
![Cluster Details!](/AKS/assets/images/enhance-security-with-os-security-patch/create-secpatch.jpg).
...
![Security Patch Schedule!](/AKS/assets/images/enhance-security-with-os-security-patch/sec-channel-schedule.png).

### Existing clusters UX in portal
...
![Select Security Patch Channel!](/AKS/assets/images/enhance-security-with-os-security-patch/sec-patch-existing.jpg).
...
![Release Tracker!](/AKS/assets/images/enhance-security-with-os-security-patch/sec-patch-reltracker.jpg).
