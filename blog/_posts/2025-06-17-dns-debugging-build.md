...
If you're reading this, you likely have heard the phrase "It's always DNS." This is a common joke amongst developers that the root of many issues is related to DNS. In this blog we aim to empower you to identify the root cause of DNS issues and get back to green.
...
Watch the full session from Microsoft Build [here](https://build.microsoft.com/en-US/sessions/BRK181).
