...
Dynamo includes an
[SLA-based Planner](https://github.com/ai-dynamo/dynamo/tree/main/docs/pages/components/planner)
...
and [SLA-based Planner](https://github.com/ai-dynamo/dynamo/tree/main/docs/pages/components/planner).
