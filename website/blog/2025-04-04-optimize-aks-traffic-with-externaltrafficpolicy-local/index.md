...
![How `externalTrafficPolicy=Local` Works](howexternaltrafficpolicyworks.png)
...
![Preventing New Requests to Unhealthy Pods](preventingnewrequeststoanunhealthypod.png)
...
1. **Delay Termination**:
   ...
   When using annotations `service.beta.kubernetes.io/azure-load-balancer-health-probe-interval` and/or `service.beta.kubernetes.io/azure-load-balancer-health-probe-num-of-probe`, consider changing the wait time to cover the annotation's needs (see [documentation](https://cloud-provider-azure.sigs.k8s.io/topics/loadbalancer/))
...
![Pod Rotation Timeline](podrotationbestpractices.png)
...
![Pod Distribution](poddistribution.png)
...
For additional best practices, you can refer to [Deployment and Cluster Reliability Best Practices for AKS](https://learn.microsoft.com/azure/aks/best-practices-app-cluster-reliability)
