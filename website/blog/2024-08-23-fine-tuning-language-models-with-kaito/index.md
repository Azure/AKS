...
![Screenshot of untuned model response](untuned-lm-with-kaito.png)
...
![Three hours later](spongebob-transition-3-hours-later.jpg)
...
![Screenshot of tuned model response](fine-tuned-lm-with-kaito.png)
