...
* Behavior Changes
  ...
  * AKS will now reject invalid OsSku enums during cluster creation, node pool creation, and node pool update. Previously AKS would default to Ubuntu. For more information on supported OsSku options, see [Azure CLI documentation](https://learn.microsoft.com/cli/azure/aks?view=azure-cli-latest#az-aks-create).
