...
* The 2022.03.20+ AKS Ubuntu 18.04 images fix an issue (present since 2022.02.19) in which an unexpected security agent to be installed, leading to higher than expected memory consumption on nodes.
