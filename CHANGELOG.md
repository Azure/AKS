...
* Component updates:
  ...
  * Bumping the Azure CNI version from v1.4.56 to v1.4.58 for AKS clusters (K8s version) This patches the CVE regarding grpc 1.52.0 dependencies - CVE-2023-2976, CVE-2020-8908
  ...
  * DNC, DNC-RC and DNCCleanup has been patched for the following security vulnerabilities: CVE-2024-21319, CVE-2024-30105, CVE-2023-45288
