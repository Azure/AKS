...
* Revision `asm-1-27` of the [Istio-based service mesh add-on](https://learn.microsoft.com/azure/aks/istio-about) has been deprecated. Please upgrade to revision 1.28 or later following the [Istio add-on upgrade guide](https://learn.microsoft.com/azure/aks/istio-upgrade). 
...
* Kubernetes patch versions [1.35.4](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.35.md), [1.34.7](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.34.md), and [1.33.11](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.33.md) are now available. These builds use Go 1.25.9, which includes fixes for customer-requested CVEs (CVE-2026-27140, CVE-2026-27143, CVE-2026-27144, CVE-2026-32282, CVE-2026-32283, CVE-2026-32288, CVE-2026-32289).
...
* New [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters now preconfigure [LocalDNS](https://learn.microsoft.com/azure/aks/localdns-custom) mode to `Required` by default, including new node pools added to existing Automatic clusters. Existing node pools are unchanged.
...
* New [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters now enable managed system node pools by default. Migration from the Base SKU to the Automatic SKU is not supported. 
* New [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters with managed system node pools now block customer-supplied SSH keys. Existing Automatic clusters with managed system node pools keep their existing keys but can't add new ones; clusters without managed system node pools are unaffected.
...
* On [AKS Automatic](https://learn.microsoft.com/azure/aks/automatic/aks-automatic-managed-system-node-pools-about) clusters with managed system node pools, `kubectl port-forward` is now denied for objects and pods running on the managed system node pool.
* [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters with managed system node pools now block read access to secrets in the `kube-system` namespace, except for known trusted identities. This mitigates the risk of attackers using the node bootstrap token to deploy pods on managed system node pools.
...
* Azure Blob Storage CSI driver image has been updated with the latest patches.
...
* [Azure CNI Powered by Cilium](https://learn.microsoft.com/azure/aks/azure-cni-powered-by-cilium) has been updated:
  ...
  * Cilium [`v1.18.9`](https://github.com/cilium/cilium/releases/tag/v1.18.9) (FIPS-compliant) agent and operator images for Kubernetes 1.34.
* [Advanced Container Networking Services (ACNS)](https://learn.microsoft.com/azure/aks/advanced-container-networking-services-overview) DNS proxy has received a patch update addressing CVEs. 
* [Azure Policy add-on](https://learn.microsoft.com/azure/governance/policy/concepts/policy-for-kubernetes) image is now FIPS-compliant (Dalec-built) and patches CVE-2026-25679, CVE-2026-27142, CVE-2026-27139, CVE-2026-32280, CVE-2025-68121, CVE-2025-61726, CVE-2025-61728, CVE-2026-32281, and CVE-2026-32283.
* [Microsoft Defender for Containers](https://learn.microsoft.com/azure/defender-for-cloud/defender-for-containers-introduction) sensor has been upgraded to [`v0.9.53`](https://learn.microsoft.com/azure/defender-for-cloud/defender-sensor-change-log#sensor-v09-aks-135-or-by-helm) on AKS 1.35+ and [`v0.8.50`](https://learn.microsoft.com/azure/defender-for-cloud/defender-sensor-change-log#sensor-v08-aks-versions-134-and-below) on AKS earlier than 1.35. 
...
* [Azure Monitor managed service for Prometheus](https://learn.microsoft.com/azure/azure-monitor/metrics/prometheus-metrics-overview) add-on has been updated with the May release. 
