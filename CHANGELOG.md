...
* 1.30 kubernetes version is now officially End of Life. Please upgrade to 1.31 version or if you require 1.30 version then switch to [AKS Long Term Support (LTS)](https://learn.microsoft.com/azure/aks/long-term-support). 
