...
* On 31 March 2025, AKS will no longer allow new cluster creation with the Basic Load Balancer. On 30 September 2025, the Basic Load Balancer will be retired. To avoid service disruptions upgrade your load balancer to the Standard Load Balancer. A simplified migration path is currently in development. See [AKS Basic LB Migration Issue](https://github.com/Azure/AKS/issues/1687) for updates.
Refer to [Basic Load Balancer Deprecation Update](https://azure.microsoft.com/updates?id=azure-basic-load-balancer-will-be-retired-on-30-september-2025-upgrade-to-standard-load-balancer) for more information.
