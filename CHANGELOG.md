...
* Added ARM64 support for [AzureContainerLinux](https://learn.microsoft.com/azure/aks/use-azure-linux-container-host) OS SKU, enabling AzureContainerLinux node pools on ARM64 VM sizes with Trusted Launch. [PR#15188854](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15188854) (PM: @allyford)
...
* Fixed an issue where Azure CNI clusters with PodSubnet configuration could not be created due to a logic error in the customvnet validator that prevented PodSubnetID from being applied to agent pools. [PR#15219348](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15219348) (AI-flagged: bug-fix)
