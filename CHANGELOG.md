...
* Bug Fixes 
  ...
  * After a [Cluster Start](https://learn.microsoft.com/en-us/azure/aks/start-stop-cluster?tabs=azure-cli) operation, pods will now correctly display the creation time from the time they were scheduled after the cluster started.
