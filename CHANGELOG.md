...
### Announcements
* East Asia region will now be one of the first regions to recieve release deployments as reflected in [release-tracker](https://releases.aks.azure.com/#tabasia).
