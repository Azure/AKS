...
* [Azure Kubernetes Fleet Manager](https://learn.microsoft.com/azure/kubernetes-fleet/) now creates `ClusterResourcePlacementStatus` resources within managed namespaces on hub clusters. This allows application team members who don't have cluster-level permissions to view placement status.
