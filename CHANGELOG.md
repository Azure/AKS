...
* Azure Policy now enables Kubernetes-native ValidatingAdmissionPolicy (VAP) by default. The toggle is retained only for emergency rollback. [PR#15052652](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15052652) (AI-flagged: behavioral-change)
...
| PR | Old Entry | Removal Reason |
|-----|-----------|----------------|
| PR#15059794 | Trusted Access mgmt group auth | API change not yet published (no TypeSpec/SDK) |
| PR#14949448 | ListVMSkus ARM manifest | API plumbing, no TypeSpec/SDK published |
| PR#15083865 | Fleet memberSelector field | API change not yet published |
| PR#14966820 | Static Egress Gateway in Delos/Bleu | Sovereign cloud toggle enablement, feature flag only |
| PR#14950397 | CAS call NPS for VMs | VMs feature not GA, toggle-gated |
| PR#15018447 | VMSize resize validation | Preview feature not yet available |
| PR#15079444 | Service Gateway swagger | API scaffolding, private swagger |
...
| PR#15080142 | Cilium rollback for COSMIC | Specific customer, toggle-gated |
| PR#15024369 | CoreDNS ENO migration | Internal delivery plumbing |
| PR#15156874 | KMS PMK feature flag Fairfax/Mooncake | AFEC flag addition |
| PR#15090585 | VMs gate check ICM fix | Non-GA toggle-gated feature |
| PR#15116177 | overlay-vap-synth gRPC CVE | Internal RP component |
| PR#14960440 | Hubble Relay v1.14 image | Image reference only |
| PR#14961382 | Cluster Health Monitor v0.0.22 | Internal component |
| PR#15156776 | etcd 3.4 gRPC CVE | Transitive dependency bump |
| PR#15160302 | secure-tls-bootstrap grpc-health-probe | Internal component |
