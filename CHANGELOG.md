...
* Behavioral Change
  * Changes to reduce the kube-reserved memory reservation and eviction threshold will not be available in 1.28 due to a release issue. These optimizations will be releasing with AKS 1.29, which previews in January 2024.
* Component Updates
