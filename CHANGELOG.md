...
* Kubernetes versions 1.28,1.29 will become **additional** [Long Term Support (LTS)](https://learn.microsoft.com/azure/aks/long-term-support) versions in AKS, alongside existing LTS versions 1.27 and 1.30.
