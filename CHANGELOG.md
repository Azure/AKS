...
* AKS node images have been updated to AgentBaker [`v0.20260527.0`](https://github.com/Azure/AgentBaker/releases), incorporating the latest weekly SIG release and node image patches. 
* AKS Windows images:
