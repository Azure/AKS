...
* The metric `ingress_upstream_latency_seconds` has been [removed](https://github.com/kubernetes/ingress-nginx/releases/tag/controller-v1.12.0) from ingress-nginx controllers deployed by the application routing add-on, following its deprecation upstream. 
