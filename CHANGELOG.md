...
* Features
  ...
  * [Dynamic allocation of IPs for Windows]( https://learn.microsoft.com/en-us/azure/aks/configure-azure-cni#:~:text=AKS%20cluster%20creation%3A-,Dynamic%20allocation%20of%20IPs%20and%20enhanced%20subnet%20support,-A%20drawback%20with) is now generally available
* Preview Features
  * [IP based Load Balancer](https://learn.microsoft.com/en-us/azure/aks/load-balancer-standard#:~:text=Change%20the%20inbound%20pool%20type%20(PREVIEW)) is now available in preview
  * [Node public IP tags](https://learn.microsoft.com/en-us/azure/aks/use-node-public-ips) is now available in preview
  * [Host port NSG control](https://learn.microsoft.com/en-us/azure/aks/use-node-public-ips) is now available in preview
  * [Host ASG control](https://learn.microsoft.com/en-us/azure/aks/use-node-public-ips) is now available in preview
  * [Azure CNI Overlay for Windows](https://learn.microsoft.com/en-us/azure/aks/azure-cni-overlay) is now available in preview
* Behavior Changes
...
* Component Updates
  * [CIS Kubernetes v1.24 Benchmark](https://learn.microsoft.com/en-us/azure/aks/cis-kubernetes) has been published which covers AKS 1.21.x through AKS 1.24.x
