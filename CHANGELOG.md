...
* Component Updates
  * Security Publisher image version has been updated to 1.0.67 from 1.0.64 which includes memory utilizaiton improvements and increased input buffer size in the fluent-bit configuration.
