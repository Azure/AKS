...
| PR#15052652 | Azure Policy VAP default enable | Toggle value still false; intent described but not yet active |
| PR#15124820 | Node disruption profile for upgrade image | Feature not yet published; no public docs (404) |
