...
* Component Updates
  ...
  * Any cluster using Auto upgrade channel Node image shall now have Linux [Unattended-upgrades](https://help.ubuntu.com/community/AutomaticSecurityUpdates)disabled by default. 
