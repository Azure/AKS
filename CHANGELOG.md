...
* Kubernetes 1.29 community version is now deprecated.
...
* Starting on 5 May, 2025, [WebAssembly System Interface (WASI) node pools](https://learn.microsoft.com/azure/aks/use-wasi-node-pools) will no longer be supported. You will no longer be able to create new WASI nodepools.
...
* Bug Fixes:
  ...
  * Fix an issue where [load balancer](https://learn.microsoft.com/azure/aks/load-balancer-standard) tags were not updated after a managed cluster tag update. Load balancer tags now correctly reflect the latest state.
  * Fix an [issue](https://github.com/cilium/cilium/issues/38210) in Cilium v1.17 where a deadlock causing pods unable to start. 
...
* Component Updates:
  ...
  * Retina Enterprise image updated to v0.1.9 to resolve [issues](https://github.com/azure-networking/retina-enterprise/releases/tag/v0.1.9) with Retina-Operator container image build on ARM64 nodes.
  * Retina base image to v0.0.30 for both Linux and Windows to resolve security vulnerabilities [CVE-2024-40635](https://nvd.nist.gov/vuln/detail/CVE-2024-40635) , [CVE-2025-30162](https://nvd.nist.gov/vuln/detail/CVE-2025-30162) and [CVE-2025-22870](https://nvd.nist.gov/vuln/detail/CVE-2025-22870).
