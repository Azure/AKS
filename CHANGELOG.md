...
* AKS Kubernetes version 1.28 will soon be available as a [Long Term Support](https://learn.microsoft.com/azure/aks/long-term-support) version.
...
* Customer on retired NCv1, NCv2, NDv1, and NVv1 VM sizes should expect to have those node pools deallocated. Please move to supported VM sizes. You can find more information and instructions to do so [here](https://github.com/Azure/AKS/issues/4847).
