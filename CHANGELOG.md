...
> Auto-generated draft of upcoming changes since the [2026-03-05 release](https://github.com/Azure/AKS/releases/tag/2026-03-05). This section covers merged PRs through daily branch `official/v20260324`.
> 
> **This is a working draft for PM review.** Entries marked `(PM: @alias)` were flagged by the PR author; entries marked `(AI-flagged: reason)` were identified by automated analysis.

### Announcements of upcoming changes and retirements

* Deprecating API versions `2023-10-02-preview`, `2023-11-02-preview`, `2024-01-02-preview`, and `2024-02-02-preview` from manifests. Customers using these API versions should migrate to newer versions. [PR#15084298](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15084298) (AI-flagged: API version deprecation)
...
* Trusted Access now supports management group-level authentication, enabling role bindings at the management group scope. [PR#15059794](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15059794) (AI-flagged: new feature scope)
* Added the `ListVMSkus` API to the ARM manifest, allowing customers to list available VM SKUs for their AKS clusters. [PR#14949448](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14949448) (AI-flagged: new API)
* Added `memberSelector` field to Fleet update run stages, enabling label-selector based update strategies for targeting specific member clusters. [PR#15083865](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15083865) (AI-flagged: new API field)
* Enabled [Static Egress Gateway](https://learn.microsoft.com/azure/aks/static-egress-gateway) in sovereign clouds (Delos and Bleu). [PR#14966820](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14966820) (AI-flagged: regional expansion)
* Enabled cluster autoscaler to call the Node Provisioning Service (NPS) for VM-based agent pools, in addition to existing VMSS pools. [PR#14950397](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14950397) (AI-flagged: new capability)
...
* Added VMSize resize validation and compatibility checks for agent pools, validating disk controller types, CPU architecture, confidential computing, and hypervisor generation before allowing resize operations. [PR#15018447](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15018447) (AI-flagged: new preview feature validation)
* Added Service Gateway (Container-Native SLB) swagger API definitions, introducing `loadBalancerSku: service`, `backendPoolType: PodIP`, and `natGatewayId` fields to the network profile. [PR#15079444](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15079444) (AI-flagged: new preview API)
* Added `AzureContainerLinux` ARM64 distro constants, extending Azure Container Linux support to ARM64 architecture. [PR#15163448](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15163448) (AI-flagged: new platform support)

#### Preview features

* Introduced new preview API version `2026-03-02-preview`. [PR#15059914](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15059914) (AI-flagged: new API version)
* Added frontend validation for Capacity Based Surge to ensure the feature uses preview API versions. [PR#14992493](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14992493) (AI-flagged: preview feature)
* Enabled VNet Scale IPv6 dual-stack support for Windows agent pools in Prefix on NIC (POND) scenarios. Previously limited to overlay networking. [PR#15017078](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15017078) (AI-flagged: new platform support)
* Added `AzureContainerLinux` as a new OS SKU option in the AKS API swagger definitions. [PR#15118410](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15118410) (AI-flagged: new OS SKU)
...
* Changed the Kubernetes version for enabling [LocalDNS](https://learn.microsoft.com/azure/aks/local-dns) by default from 1.35 to 1.36. [PR#14990947](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14990947) (AI-flagged: default config change)
* Enabled COSMIC Linux clusters to upgrade to Cilium eBPF host routing from Azure CNI, with a one-shot upgrade path. [PR#15018990](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15018990) (AI-flagged: behavioral change)
* Azure Policy now enables Kubernetes-native ValidatingAdmissionPolicy (VAP) by default. The toggle is retained only for emergency rollback. [PR#15052652](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15052652) (AI-flagged: default behavior change)
* Network isolated clusters now block BYO ACR with Domain Name Label (DNL) enabled, as DNL-enabled ACR URLs are incompatible with the expected format. [PR#15089634](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15089634) (AI-flagged: new validation rule)
* Blocked `RotateClusterCertificates` operation for clusters running deprecated OS distros, preventing certificate rotation failures on unsupported configurations. [PR#15127500](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15127500) (AI-flagged: new validation rule)
* The `ListVMSkus` API now filters out VM SKUs that are restricted in all availability zones, showing only deployable SKUs. [PR#15105018](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15105018) (AI-flagged: API behavior improvement)
* Allowed Cilium rollback for COSMIC Linux subscriptions, per customer request. [PR#15080142](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15080142) (AI-flagged: customer-requested change)
* Added API-level validation to reject mTLS transit encryption on Kubernetes versions below 1.34, as mTLS requires Cilium 1.18+ which is only available on K8s 1.34+. [PR#15016001](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15016001) (AI-flagged: new validation rule)
* CoreDNS delivery is migrating from addon-manager to ENO synthesizer when the migration toggle is enabled, improving deployment reliability. [PR#15024369](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15024369) (AI-flagged: delivery mechanism change)
* Added [node disruption profile](https://learn.microsoft.com/azure/aks/node-disruption-profile) validation to the upgrade node image operation, enabling customers to block or restrict node image upgrades via maintenance windows. [PR#15124820](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15124820) (AI-flagged: behavioral change for node image upgrades)
* Updated [KMS](https://learn.microsoft.com/azure/aks/use-kms-etcd-encryption) frontend check to block certificate rotation for clusters using KMS with private key vault and private cluster v1 configuration. [PR#15150856](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15150856) (AI-flagged: new validation rule)
* Updated egress lockdown required FQDNs for Azure China Cloud (Mooncake) to remove global `mcr.microsoft.com` endpoints, as Mooncake uses `mcr.azure.cn` instead. [PR#15137304](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15137304) (AI-flagged: egress FQDN change for sovereign cloud)
* Enabled KMS Platform Managed Key (PMK) preview feature flag in Fairfax and Mooncake sovereign clouds with AutoEnroll enrollment type. [PR#15156874](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15156874) (AI-flagged: sovereign cloud feature expansion)
...
* Fixed an issue (ICM 760313997) where the VirtualMachines gate check blocked upgrades on clusters that already had VM-type agent pools in sovereign regions. [PR#15090585](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15090585) (AI-flagged: customer-impacting bug fix)
* Fixed an issue where HTTP proxy `noProxy` entries with a valid trailing dot (e.g., `example.com.`) were incorrectly rejected during cluster validation. [PR#15097768](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15097768) (AI-flagged: customer-impacting validation bug fix)
* Fixed an issue where [VPA](https://learn.microsoft.com/azure/aks/vertical-pod-autoscaler) admission controller pods served stale TLS certificates after AKS certificate rotation, causing VPA to silently stop functioning. [PR#15059681](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15059681) (AI-flagged: customer-impacting bug fix)
* Re-enabled the same Key Vault check when enabling KMS, preventing customers from accidentally using a shared Key Vault which could cause issues. [PR#15020170](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15020170) (AI-flagged: re-enabled validation)
* Fixed an issue where Fleet cluster mesh members could not be deleted while in the `Connecting` state. [PR#15090025](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15090025) (AI-flagged: customer-impacting bug fix)
* Fixed a day-0 bug where Karpenter could pick up an expired bootstrap token from a stopped agent pool, causing new node provisioning to fail. [PR#15091039](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15091039) (AI-flagged: customer-impacting bug fix)
* Added support for Application Load Balancer (ALB) identity exemption in NRG lockdown deny assignments, preventing ALB operations from being blocked by node resource group lockdown. [PR#15007857](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15007857) (AI-flagged: customer-impacting fix)
* Improved error handling to return a clear `400 BadRequest` error for non-zonal node pools when the requested VM size is restricted in all availability zones, instead of a confusing CRP failure. [PR#15096609](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15096609) (AI-flagged: improved error message)
* Fixed Application Gateway Ingress Controller (AGIC) add-on subnet validation errors for subnet-by-ID scenarios. [PR#15037462](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15037462) (AI-flagged: bug fix affecting addon)
...
* Improved performance of user-defined routing (UDR) subnet validation by parallelizing checks, preventing ARM timeouts on clusters with many subnets. [PR#15008920](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15008920) (AI-flagged: performance fix)
* Fixed Istio add-on resource limits to allow smaller resource usage configurations as requested by customers. [PR#15000622](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15000622) (AI-flagged: customer-requested fix)
* Fixed a race condition during [Fleet](https://learn.microsoft.com/azure/kubernetes-fleet/overview) membership creation where concurrent attempts to join the same cluster to different fleets could silently succeed, potentially leaving the cluster in the wrong fleet. [PR#15113084](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15113084) (AI-flagged: customer-impacting bug fix)
* Fixed VM size validation to allow custom sizes even when the CRP available sizes list is empty. [PR#15114185](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15114185) (AI-flagged: customer-impacting validation fix)
* Fixed an upgrade race condition where getting a VM InstanceView could return a 404 error for a VM that is being deleted, causing upgrade failures. [PR#15149532](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15149532) (AI-flagged: customer-impacting bug fix)
* Fixed a latent bug where kubelet feature gate removal during upgrades used the cluster-level Kubernetes version instead of each agent pool's version, which could cause kubelet startup failures when upgrading pools individually. [PR#15148050](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15148050) (AI-flagged: latent customer-impacting bug fix)
* Fixed control plane provisioning to always backfill the control plane IP address, preventing cluster deadlock when a prior operation failed mid-provisioning. [PR#15138515](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15138515) (AI-flagged: incident-driven fix)
...
* Updated Azure NPM image to v1.6.42, resolving CVEs identified in v1.6.39. [PR#15101674](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15101674) (AI-flagged: component version update resolving CVEs)
* Updated Azure CNI and CNS to v1.7.15. [PR#15102749](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15102749) (AI-flagged: component version update)
* Updated [KAITO](https://learn.microsoft.com/azure/aks/ai-toolchain-operator) to v0.9.3. [PR#15037204](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15037204) (AI-flagged: component version update)
* Updated Application Gateway Ingress Controller (AGIC) add-on to version 1.9.16. [PR#14987718](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14987718) (AI-flagged: component version update)
* Updated Cluster Health Monitor to v0.0.22, with JSON log parser for CheckNodeHealth Controller. [PR#14961382](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14961382) (AI-flagged: component version update)
* Patched CVE-2026-33186 in the overlay ValidatingAdmissionPolicy synthesizer by updating gRPC to v1.79.3. [PR#15116177](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15116177) (AI-flagged: CVE fix in customer-facing component)
* Added Hubble Relay v1.14 image for [Cilium-based observability](https://learn.microsoft.com/azure/aks/azure-cni-powered-by-cilium). [PR#14960440](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14960440) (AI-flagged: component update)
...
* Updated addon-token-adapter to master.260322.2 to fix CVEs. [PR#15146595](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15146595) (AI-flagged: CVE fix in customer-facing component)
* Fixed CVEs in etcd 3.4 by updating gRPC to v1.79.3. [PR#15156776](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15156776) (AI-flagged: CVE fix in customer-facing component)
* Fixed FedRAMP CVEs in secure TLS bootstrap server by bumping grpc-health-probe to v0.4.46. [PR#15160302](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15160302) (AI-flagged: CVE fix)
