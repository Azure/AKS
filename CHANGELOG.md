...
* Behavioral Change
  * Dual-stack clusters created with a managed vnet will generate a pseudo-random IPv6 address space to comply with RFC 4193, rather than using the default static value of `2001:1234:5678:9a00::/56`.
* Component Updates
