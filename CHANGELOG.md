...
* Revision `asm-1-27` of the [Istio-based service mesh add-on](https://learn.microsoft.com/azure/aks/istio-about) has been deprecated. Please upgrade to revision 1.28 or later following the [Istio add-on upgrade guide](https://learn.microsoft.com/azure/aks/istio-upgrade). [PR#15762173](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15762173) (PM: @mitchconnors)
* Windows Server 2019 was retired on 1 March 2026 and its preview feature flag has been removed. New node pools can no longer be created with Windows Server 2019; migrate to a supported Windows Server version. For more information, see [aka.ms/aks/ws2019-retirement-github](https://aka.ms/aks/ws2019-retirement-github). [PR#15652029](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15652029) (PM: @allyford)
...
* [Windows Server 2025](https://learn.microsoft.com/azure/aks/windows-server-2025) is now generally available. You no longer need to register a feature flag to create Windows Server 2025 node pools. [PR#14650042](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14650042) (PM: @allyford)
* [Azure Container Linux OS SKU](https://learn.microsoft.com/azure/aks/use-azure-linux) is now being enabled for general rollout, including FIPS image selection for clusters that require Federal Information Processing Standard compliance. [PR#15783286](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15783286) (PM: @allyford), [PR#15863378](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15863378) (PM: @allyford)
* [Azure Policy add-on](https://learn.microsoft.com/azure/governance/policy/concepts/policy-for-kubernetes) now generates ValidatingAdmissionPolicies (VAP) for all customers. This enforces CEL-based policies inside the API server process for minimal latency and enables fail-closed enforcement. [PR#14953072](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/14953072) (PM: @colinmixon)


#### Preview features

* [Azure Linux 3.0 confidential VM (CVM)](https://learn.microsoft.com/azure/aks/use-azure-linux) is now available in preview in Fairfax (US Gov) regions. Register the `AzureLinuxCVMPreview` feature to enable it. [PR#15569565](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15569565) (PM: @allyford)
* [Confidential VM (CVM)](https://learn.microsoft.com/azure/confidential-computing/confidential-vm-overview) node pools are now available in the US Gov Virginia region as the Arm64 confidential hardware footprint expands to additional sovereign clouds. [PR#15553674](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15553674) (PM: @allyford)
* [In-place node pool resize](https://learn.microsoft.com/azure/aks/resize-node-pool) is now available in preview. Resize the VM size of an existing VMSS-based node pool in place via `az aks nodepool update --node-vm-size`, without manually creating and migrating to a new node pool. [PR#15556705](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15556705) (PM: @yudian)

#### Behavioral changes

* [LocalDNS](https://aka.ms/aks/localdns) is now automatically enabled on node pools running Kubernetes 1.36 or later. Node pools with preconfigured LocalDNS or upstream NodeLocal DNS, Cilium or Calico clusters with network policies enabled, and bring-your-own (BYO) CNI clusters are excluded. To disable it, see [aka.ms/aks/localdns](https://aka.ms/aks/localdns). [PR#15536997](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15536997) (PM: @vaibhavarora)
* New [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters now preconfigure [LocalDNS](https://learn.microsoft.com/azure/aks/localdns-custom) mode to `Required` by default, including new node pools added to existing Automatic clusters. Existing node pools are unchanged. [PR#15661703](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15661703) (PM: @wangamanda), [PR#15673309](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15673309) (PM: @rhulrai)
* [Node Auto Provisioning (NAP)](https://learn.microsoft.com/azure/aks/node-autoprovision) Standard SKU clusters running Kubernetes 1.36 or later now default to LocalDNS mode `Preferred` on the default and system-surge `AKSNodeClass` resources, improving DNS resolution performance and resilience. Existing in-cluster `AKSNodeClass` specs are preserved. [PR#15891364](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15891364) (PM: @rhulrai)
* New [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters now enable managed system node pools by default. Migration from the Base SKU to the Automatic SKU is not supported. [PR#15824806](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15824806) (PM: @wangamanda)
* New [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters with managed system node pools now block customer-supplied SSH keys. Existing Automatic clusters with managed system node pools keep their existing keys but can't add new ones; clusters without managed system node pools are unaffected. [PR#15686165](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15686165) (PM: @wangamanda)
* [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters now enforce a ValidatingAdmissionPolicy that blocks Services from setting `spec.externalIPs`, in line with the [upstream deprecation of Service externalIPs](https://kubernetes.io/blog/2026/05/14/kubernetes-v1-36-deprecation-and-removal-of-service-externalips/). The policy applies immediately to Automatic clusters with managed system node pools, and to Automatic clusters without managed system node pools starting in Kubernetes 1.36. [PR#15573997](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15573997) (PM: @wangamanda)
* On [AKS Automatic](https://learn.microsoft.com/azure/aks/automatic/aks-automatic-managed-system-node-pools-about) clusters with managed system node pools, `kubectl port-forward` is now denied for objects and pods running on the managed system node pool. [PR#15572557](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15572557) (PM: @wangamanda)
* [AKS Automatic](https://learn.microsoft.com/azure/aks/intro-aks-automatic) clusters with managed system node pools now block read access to secrets in the `kube-system` namespace, except for known trusted identities. This mitigates the risk of attackers using the node bootstrap token to deploy pods on managed system node pools. [PR#15872826](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15872826) (PM: @wangamanda)
* [Deployment safeguards](https://learn.microsoft.com/azure/aks/deployment-safeguards) in Enforce mode with Pod Security Standards set to Baseline now allow pods on Automatic clusters to read the `/var/log` and `/hostfs` hostpaths (read-only), supporting log exporter scenarios and reaching parity with GKE Autopilot. [PR#15677310](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15677310) (PM: @asabbour)
* Users with the Azure Kubernetes Service Contributor or Contributor role (with `Microsoft.ContainerService/deploymentSafeguards/write` permission) can now [edit the `excludedNamespaces` field for deployment safeguards](https://learn.microsoft.com/azure/aks/deployment-safeguards#excluding-namespaces) on Automatic clusters, controlling which policies apply to specific namespaces. [PR#15842717](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15842717) (PM: @wangamanda)
* [Application routing](https://learn.microsoft.com/azure/aks/app-routing) gateways using the Gateway API now write access logs to stdout by default for the managed (meshless) Istio configuration. [PR#15729529](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15729529) (PM: @mitchconnors)
* The [application routing](https://learn.microsoft.com/azure/aks/app-routing) operator now supports DNS and TLS integrations for the Gateway API. [PR#15580786](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15580786) (PM: @mitchconnors)
* AKS now allows migration from the `managedNATGatewayV2` outbound type to the `block` and `none` outbound types, supporting [network-isolated cluster](https://learn.microsoft.com/azure/aks/concepts-network-isolated) scenarios. Migration to other outbound types remains blocked. [PR#15700505](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15700505) (PM: @rhulrai)
* AKS now validates pod CIDR ranges during cluster create and update for kubenet and [Azure CNI Overlay](https://learn.microsoft.com/azure/aks/azure-cni-overlay) clusters. Clusters can no longer be created or updated with a pod CIDR that overlaps with reserved IP ranges (`172.30.0.0/16`, `172.31.0.0/16`), preventing potential in-cluster networking failures. Existing clusters with an overlapping pod CIDR are unaffected. See [CNI prerequisites](https://learn.microsoft.com/azure/aks/concepts-network-cni-overview#prerequisites). [PR#15865372](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15865372) (PM: @rhulrai)
* AKS now rejects [Calico NPM and Azure NPM](https://learn.microsoft.com/azure/aks/use-network-policies) network policy install and uninstall operations on clusters running Kubernetes versions earlier than 1.30. Requests are rejected at the API level with a descriptive error asking you to upgrade to Kubernetes 1.30 or later first. Existing clusters already using Calico NPM or Azure NPM are unaffected. [PR#15650682](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15650682) (PM: @rhulrai)

#### Bug fixes

* Fixed an issue in the [Istio-based service mesh add-on](https://learn.microsoft.com/azure/aks/istio-about) where operations on `v1beta1` Gateway resources were incorrectly rejected with an "Unknown gvk" error from the admission webhook. The webhook now registers a handler for `v1beta1` Gateway resources. [PR#15823980](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15823980) (PM: @mitchconnors)
* Fixed a bug where the [Multiple Standard Load Balancers](https://learn.microsoft.com/azure/aks/load-balancer-standard) rebalance operation ignored orphaned nodes (nodes present in the cluster but not on any load balancer backend pool). Orphaned nodes are now included during rebalancing and distributed evenly across load balancers. [PR#15121260](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15121260) (PM: @rhulrai)
* Fixed a bug where a cluster create or update could report success but silently fail to install Karpenter or KEDA. The operation now fails and returns an error describing the installation failure. [PR#15520054](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15520054) (PM: @wilsondarko)

#### Component updates

* Azure Blob Storage CSI driver image has been updated with the latest patches. [PR#15873612](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15873612) (PM: @allenwen)
* Azure Disk CSI Driver has been upgraded:
  ...
  * [PR#15879954](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15879954) (PM: @allenwen)
* Azure File CSI Driver has been upgraded:
  ...
  * [PR#15808095](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15808095) (PM: @allenwen)
* Cloud Provider Azure has been updated to include the [`v1.36.0`](https://cloud-provider-azure.sigs.k8s.io/) release. `cloud-controller-manager` and `cloud-node-manager` are now mapped to `v1.36.1-1` for Kubernetes 1.36, supported minor versions were bumped for 1.32–1.35, and `health-probe-proxy` was updated from `v1.35.3-2` to `v1.36.1-1`. [PR#15853573](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15853573) (PM: @rhulrai)
* [Azure CNI Powered by Cilium](https://learn.microsoft.com/azure/aks/azure-cni-powered-by-cilium) has been updated:
  * Cilium [`v1.19.3`](https://github.com/cilium/cilium/releases/tag/v1.19.3) (agent, operator, ACNS, cilium-envoy, Hubble, ClusterMesh) for Kubernetes 1.36+. [PR#15781507](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15781507) (PM: @josephyostos)
  * Cilium [`v1.18.9`](https://github.com/cilium/cilium/releases/tag/v1.18.9) (FIPS-compliant) agent and operator images for Kubernetes 1.34. [PR#15677344](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15677344) (PM: @josephyostos)
* [Advanced Container Networking Services (ACNS)](https://learn.microsoft.com/azure/aks/advanced-container-networking-services-overview) DNS proxy has received a patch update addressing CVEs. [PR#15884655](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15884655) (PM: @josephyostos)
* [Azure Policy add-on](https://learn.microsoft.com/azure/governance/policy/concepts/policy-for-kubernetes) image is now FIPS-compliant (Dalec-built) and patches CVE-2026-25679, CVE-2026-27142, CVE-2026-27139, CVE-2026-32280, CVE-2025-68121, CVE-2025-61726, CVE-2025-61728, CVE-2026-32281, and CVE-2026-32283. [PR#15848994](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15848994) (PM: @colinmixon)
* [Microsoft Defender for Containers](https://learn.microsoft.com/azure/defender-for-cloud/defender-for-containers-introduction) sensor has been upgraded to [`v0.9.53`](https://learn.microsoft.com/azure/defender-for-cloud/defender-sensor-change-log#sensor-v09-deployed-by-helm-or-arc-for-k8s-in-preview-mode) on AKS 1.35+ and [`v0.8.50`](https://learn.microsoft.com/azure/defender-for-cloud/defender-sensor-change-log#sensor-v08-relevant-to-all-aks-supported-versions-and-arc-for-k8s) on AKS earlier than 1.35. [PR#15453964](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15453964) (PM: @shasb)
* [Microsoft Defender for Containers](https://learn.microsoft.com/azure/defender-for-cloud/defender-for-containers-introduction) sensor [`v0.10`](https://learn.microsoft.com/azure/defender-for-cloud/defender-sensor-change-log#sensor-v010-deployed-by-helm-or-arc-for-k8s) is now available on AKS 1.36. [PR#15754499](https://dev.azure.com/msazure/CloudNativeCompute/_git/aks-rp/pullrequest/15754499) (PM: @shasb)
